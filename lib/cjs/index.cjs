...
var require_consola = __commonJS({
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module2) {
    "use strict";
    function u(u2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
...
// node_modules/.pnpm/changelogen@0.3.5/node_modules/changelogen/dist/shared/changelogen.af4c8447.mjs
...
// node_modules/.pnpm/changelogen@0.3.5/node_modules/changelogen/dist/index.mjs
...
var assertRepoNotShallow = async () => import_node_assert.default.notEqual(
...
async function getLastGitTag2() {
  const list = (await exec("git", ["--no-pager", "tag", "-l", "--sort=creatordate"])).split("\n").filter(
    (value) => import_semver3.default.clean(value, SEMVER_OPTIONS) !== null
  );
...
var toSemver = (props) => {
  ...
  const version = import_semver3.default.parse(string, SEMVER_OPTIONS);
  core.debug(
    `toSemver()
 ${JSON.stringify([
...
var getVersion = async () => {
  if (REF_TYPE === "tag") {
    const version = import_semver3.default.parse(
      import_semver3.default.clean(REF_NAME, SEMVER_OPTIONS),
      SEMVER_OPTIONS
    );
    if (version === null) {
    ...
    if (lastGitTag === void 0) {
      return import_semver3.default.parse(
        `0.1.0-${preReleaseCase(branch)}+${COMMITISH}`,
        SEMVER_OPTIONS
      );
    } else {
      core.info(`Last tag: ${lastGitTag}`);
      const { major, minor, patch } = import_semver3.default.parse(
        import_semver3.default.clean(lastGitTag, SEMVER_OPTIONS),
        SEMVER_OPTIONS
      );
      return toSemver({
