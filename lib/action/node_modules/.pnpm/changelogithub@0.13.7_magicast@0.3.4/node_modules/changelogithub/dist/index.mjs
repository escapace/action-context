...
async function getLastMatchingTag(inputTag) {
  ...
  if (!isPrerelease2 && isVersion) {
    tag = tags.find((tag2) => {
      ...
      return tagWithoutPrefix !== inputTagWithoutPrefix && semver.valid(tagWithoutPrefix) !== null && semver.prerelease(tagWithoutPrefix) === null;
    });
  }
...
export { defineConfig, generate, generateMarkdown, getCurrentGitBranch, getFirstGitCommit, getGitHubRepo, getGitTags, getLastMatchingTag, hasTagOnGitHub, isPrerelease, isRefGitTag, isRepoShallow, parseCommits, resolveAuthorInfo, resolveAuthors, resolveConfig, sendRelease };
