...
exports.reportMisc = exports.LOG_LEVEL_NUMBER = void 0;
...
function reportMisc(log$, opts) {
    const maxLogLevel = exports.LOG_LEVEL_NUMBER[opts.logLevel ?? 'info'] ?? exports.LOG_LEVEL_NUMBER['info'];
    ...
    return Rx.merge(log$.registry, log$.other).pipe((0, operators_1.filter)((obj) => exports.LOG_LEVEL_NUMBER[obj.level] <= maxLogLevel &&
        ...
        switch (obj.level) {
            ...
            case 'error': {
                const errorOutput = (0, reportError_1.reportError)(obj, opts.config, opts.peerDependencyRules);
                if (!errorOutput)
                    return Rx.NEVER;
                if (obj['prefix'] && obj['prefix'] !== opts.cwd) {
                    return Rx.of({
                        msg: `${obj['prefix']}:` + os_1.default.EOL + errorOutput,
                    });
                }
