...
const signedBotCommit = (login: string): PullRequestCommitMetadata => ({
...
const unsignedBotCommit = (login: string): PullRequestCommitMetadata => ({
  author: { login, type: 'Bot' },
  authorDate: null,
  committerDate: null,
  sha: 'abc123',
...
const signedHumanCommit = (login: string): PullRequestCommitMetadata => ({
...
const unsignedHumanCommit = (login: string): PullRequestCommitMetadata => ({
  author: { login, type: 'User' },
  authorDate: null,
  committerDate: null,
  sha: 'abc123',
...
const nullAuthorCommit: PullRequestCommitMetadata = {
  author: null,
  authorDate: null,
  committerDate: null,
  sha: 'abc123',
...
describe('isCommitTrusted', () => {
  ...
  it('unknown author type → false', () => {
    const commit: PullRequestCommitMetadata = {
...
const createContext = (
  octokit: Octokit,
  trustedBotsOverride: Set<string> = trustedBots,
